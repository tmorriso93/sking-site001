        ...
        <div className='xxl:mx-20 lg:mx-18 mx-auto max-w-[1260] w-full'>
            <div className='flex items-center justify-between text-[#00133d]
                ...
                <div className='cursor-pointer'>
                    <Image src={Logo} alt='Logo' className='lg:w-[75px] lg:h-[75px] 
                            sm:w-[50px] sm:h-[50px] w-[40px] h-[40px] ml-[8px] lg:ml-0 lg:mt-6' />
                </div>

                <div className='absolute md:right-[40px] right-[8px] top-4 cursor-pointer lg:hidden' onClick={()=> 
                    setOpen(!open)}>
                    <span>
                        {open ? <AiOutlineClose className='w-[30px] h-[30px] mt-[8px]'/> : <GiHamburgerMenu className='w-[30px] h-[30px] mt-[8px]' />}
                    </span>
                </div>
